...
![](https://img.shields.io/badge/JobQuest-FE-orange)
![](https://img.shields.io/travis/com/JobQuest/jobquest-fe)
<br />
...
1. Download and install the <a href="https://github.com/JobQuest/jobquest-be">Back-end repo</a>
1. Run `npm start` to view the development server (usually on `localhost3000`
