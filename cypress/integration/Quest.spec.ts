...
describe("Testing the single event details page", () => {
  ...
  it("Should display a single quest upon clicking on a quest card", () => {
    ...
    cy.get("[data-cy=single-quest-container]")
      .should("be.visible")
      .get(".monster-health-container").should("be.visible")
      .get("[data-cy=encounter-story-container]").should("be.visible")
      .get(".img-hero").should("be.visible")
      .get(".img-monster").should("be.visible")
      .get("[data-cy=quest-details]").should("be.visible")
      .get(".single-quest-details__title").should("be.visible").and("have.length", 2)
      .get("[data-cy=action-cards-container]").should("be.visible")
      .get(".encounter-details__action-card").should("have.length", 2)
  });
